...
echo "[3/9] Regenerating main-run summary plots with all compared models"
...
ours = None
for row in rows:
    if row["scheme"] == "Our-TemporalGraph":
        ours = row
        break
...
all_best = (
    reward_best["scheme"] == "Our-TemporalGraph"
    and local_best["scheme"] == "Our-TemporalGraph"
    and paper_best["scheme"] == "Our-TemporalGraph"
    and cloud_best["scheme"] == "Our-TemporalGraph"
)
